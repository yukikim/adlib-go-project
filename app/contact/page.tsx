...
export default function ContactPage() {
  return (
    <main className="jazz-page min-h-svh">
      <section className="jazz-staff border-b border-[#f4eddf]/15 px-4 py-20 sm:px-6 lg:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-6 max-w-4xl font-serif text-[clamp(3.7rem,13vw,8rem)] leading-[0.86] tracking-[-0.06em]">
            Let&apos;s
            <br />
            <span className="text-[#d7a94f] italic">talk.</span>
          </h1>
      ...
      <section className="jazz-paper-grid bg-[#e9e0cf] px-4 py-16 text-[#153027] sm:px-6 lg:py-24">
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[0.45fr_1fr]">
          <div>
            <p className="text-[10px] font-bold tracking-[0.2em] text-[#153027]/55">
              MESSAGE FORM
            </p>
            ...
            <p className="mt-4 text-sm leading-7 text-[#153027]/60">
              すべての項目を入力してください。送信内容は運営への連絡にのみ使用します。
            </p>
          </div>
          <div className="border border-[#153027]/25 bg-[#f4eddf]/60 p-5 sm:p-8">
            <ContactForm />
          </div>
        </div>
      </section>
